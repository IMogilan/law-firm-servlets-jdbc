...
# 1. Create database law_firm (first line in test-create-tables-script.sql)
# 2. Created tables in law_firm by execution of test-create-tables-script.sql
# 3. Populate tables by execution of test-populate-script.sql
